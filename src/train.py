...
class Tranner:
    def __init__(self,model_name,max_seq_length=1024,load_in_4bit=True,TUNE_MODEL_NAME='myModel',TUNE_MODEL_VERSION='v1.0'):
    ...
    def loadModel(self):
        ...
        self.get_peft_model(self.model)
    ...
    def load_data(self,dataset,alpaca_prompt,formatting_prompts_func):
    ...
    def createTrainner(self,train_dataset,eval_dataset):
    ...
    def startTrainAndSave(self,dir_path='myModel-v1.0',save_method='merged_4bit_forced'):
        trainer_stats = self.trainer.train()
        self.model.save_pretrained_merged(dir_path, self.tokenizer,save_method)
        wandb.finish()